...
We have tried to make the site easy to use and understand, no matter what technology or browsing method you are using. For example, you should be able to:
...
If you have any difficulties or annoyances using the site, or feel that we are not meeting accessibility requirements, then please contact us (<biohackathon-europe@elixir-europe.org>). We will do our best to make the site easier to use.

## How we assess the accessibility of the site
We assessed the accessibility of the site using:
...
The website was last tested on 5 March 2024.

## Level of compliance
As far as we can ascertain, this website is compliant with the Web Content Accessibility Guidelines version 2.1 AA standard. If you feel there are issues to address, however, then please email <biohackathon-europe@elixir-europe.org>.
